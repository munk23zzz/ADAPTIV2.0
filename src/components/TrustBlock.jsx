...
const TrustBlock = () => {
  return (
    <section className="py-20 relative">
        ...
        >
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm overflow-hidden h-full flex flex-col justify-center">
        ...
        >
          <div className="flex-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl flex flex-col justify-center items-center gap-8 md:gap-10 p-8 shadow-sm">
            
            {/* RAG Nodes */}
            <div className="flex flex-col md:flex-row items-stretch justify-center gap-3 md:gap-4 w-full">
              <motion.div 
                className="flex-1 w-full md:w-auto p-4 flex flex-col items-center justify-center text-center font-bold text-slate-800 dark:text-slate-200 border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 shadow-sm rounded-xl"
              ...
              <div className="text-slate-400 animate-pulse rotate-90 md:rotate-0 flex items-center justify-center">
                <span className="material-icons-round text-3xl">arrow_forward</span>
              </div>
              
              <motion.div 
                className="flex-1 w-full md:w-auto p-4 flex flex-col items-center justify-center text-center font-bold text-slate-800 dark:text-slate-200 border-2 border-blue-500 bg-slate-50 dark:bg-slate-900 shadow-sm rounded-xl"
                animate={{ opacity: [0.7, 1, 0.7], scale: [0.98, 1, 0.98] }}
              ...
              <motion.div 
                className="flex-1 w-full md:w-auto p-4 flex flex-col items-center justify-center text-center font-bold text-slate-800 dark:text-slate-200 border-2 border-cyan-500 bg-slate-50 dark:bg-slate-900 shadow-sm rounded-xl overflow-hidden"
                animate={{ opacity: [0.7, 1, 0.7], scale: [0.98, 1, 0.98] }}
            ...
            <div className="px-6 py-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 w-full shadow-sm mt-auto">
